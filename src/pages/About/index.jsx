        ...
        <main id="about">
            <article className="about-article" id="summary">
                ...
                <div className="about-article-content">
                    ...
                    <section className="about-section">
                        <p className="about-section-content">
                            In my time orbiting the Sun on the planet we call Earth I have fallen in love with physics, coding, and music (playing multiple instruments in my free time over the years).
                        </p>
                        <p className="about-section-content">
                            Scroll down if you want to read more about my <a className="about-link" href="#journey">journey</a> through life or to read about my <a className="about-link" href="#hobbies">hobbies</a>.
                        </p>
                    </section>
                </div>
            </article>
