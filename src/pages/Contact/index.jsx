            ...
            <div className="contact-container">
                <div id="contactMethods">
                    <div className="contact-method">
                        <FontAwesomeIcon className="contact-icon" icon={faEnvelope} size="2x" />
                    ...
                    <div className="contact-method">
                        <FontAwesomeIcon className="contact-icon" icon={faGithubSquare} size="2x" />
                        <div className="contact-method-text">
                    ...
                    <div className="contact-method">
                        <FontAwesomeIcon className="contact-icon" icon={faMapMarkerAlt} size="2x" />
                        <div className="contact-method-text">
